...
export function trackTransaction(
  ...
  tr.steps.forEach((step) => {
    ...
    if (iters > 20) {
      console.error(
        '@make-me-a-cup-of-tea/track-changes-plugin: Possible infinite loop in iterating tr.steps, tracking skipped!\n' +
      ...
      console.error(
        '@make-me-a-cup-of-tea/track-changes-plugin: Multiple prosemirror-transform packages imported, alias/dedupe them ' +
